...
1. First action: create your branch: `git checkout -b fm/merged-smoke --`
...
4. Report status by appending one line:
   `echo "{state} [at=<epoch>]: {one short line}" >> '/Users/akanshuarghjain/.no-mistakes/evidence/01M39PEE47J8K6D3MT8CS4KSRB/live-fm-home/state/merged-smoke.status' && { [ ! -e '/Users/akanshuarghjain/.no-mistakes/evidence/01M39PEE47J8K6D3MT8CS4KSRB/live-fm-home/config/fleet-ledger' ] || '/Users/akanshuarghjain/.no-mistakes/worktrees/a2966c90697b/01M39PEE47J8K6D3MT8CS4KSRB/bin/fm-fleet-ledger.sh' appended '/Users/akanshuarghjain/.no-mistakes/evidence/01M39PEE47J8K6D3MT8CS4KSRB/live-fm-home/config' '/Users/akanshuarghjain/.no-mistakes/evidence/01M39PEE47J8K6D3MT8CS4KSRB/live-fm-home/state/merged-smoke.status' >/dev/null 2>&1 || true; }`
...
6. If a decision belongs above the implementation worker (product choices, destructive actions),
   ...
   For a no-mistakes ask-user gate specifically, escalate all ask-user findings as one event plus one snapshot file, using that same shape even when the gate holds only a single ask-user finding: write only the ask-user findings, verbatim and unparaphrased (id, severity, file, line, description, authority), to `/Users/akanshuarghjain/.no-mistakes/evidence/01M39PEE47J8K6D3MT8CS4KSRB/live-fm-home/data/merged-smoke/nm-<run>-findings.txt`, then report the gate with
   `needs-decision [at=<epoch>] [key=nm-<run>-<step>]: ask-user findings=<id1>,<id2>,... file=/Users/akanshuarghjain/.no-mistakes/evidence/01M39PEE47J8K6D3MT8CS4KSRB/live-fm-home/data/merged-smoke/nm-<run>-findings.txt`
...
Firstmate steers you through durable message files in '/Users/akanshuarghjain/.no-mistakes/evidence/01M39PEE47J8K6D3MT8CS4KSRB/live-fm-home/state/merged-smoke.inbox'.
When a terminal message says an instruction is waiting there - and at any natural checkpoint when you are unsure - list '/Users/akanshuarghjain/.no-mistakes/evidence/01M39PEE47J8K6D3MT8CS4KSRB/live-fm-home/state/merged-smoke.inbox'/*.msg, read and act on each message in numeric order, then acknowledge each handled message by moving it: `mv '/Users/akanshuarghjain/.no-mistakes/evidence/01M39PEE47J8K6D3MT8CS4KSRB/live-fm-home/state/merged-smoke.inbox'/NNN.msg '/Users/akanshuarghjain/.no-mistakes/evidence/01M39PEE47J8K6D3MT8CS4KSRB/live-fm-home/state/merged-smoke.inbox'/handled/`.
The move IS the acknowledgement: without it firstmate rings again and eventually treats you as stuck. An empty or absent inbox needs no action.

# Project memory
If `AGENTS.md` or `CLAUDE.md` already exists, or if this task produced durable project-intrinsic knowledge, run `/Users/akanshuarghjain/.no-mistakes/worktrees/a2966c90697b/01M39PEE47J8K6D3MT8CS4KSRB/bin/fm-ensure-agents-md.sh .` in the worktree.
Record only project knowledge useful to almost every future session.
For anything the codebase already shows, prefer a pointer to the authoritative file, command, or doc over copying the detail.
If you touch a project `AGENTS.md`, follow `/Users/akanshuarghjain/.no-mistakes/worktrees/a2966c90697b/01M39PEE47J8K6D3MT8CS4KSRB/bin/fm-ensure-agents-md.sh`'s self-governance contract in the same pass.
Keep it proportionate: skip `AGENTS.md` edits for trivial tasks that produced no durable project knowledge.

# Definition of done
Delivery contract: mode=no-mistakes
Ship branch: fm/merged-smoke
