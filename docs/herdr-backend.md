...
An ambiguous away submit keeps the exact offered body durable and never retypes it automatically; the shared away contract in the `/afk` skill owns reconciliation and return catch-up.
